...
But this shit will take time, so have patience, I'll try to complete this before my semester examination. (update: i didn't!)
...
- _question-answering.py_ - answers user questions, using the given context
- _fill-mask.py_ - completes the masked word in a given sentence, with multiple scores, no context required
