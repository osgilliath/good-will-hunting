...
- _pdf-to-text.py_ - reading text from .pdf file, will make a single file that can check the format of the input file and extract text no matter what format, but mid sems now, so laterrrr
